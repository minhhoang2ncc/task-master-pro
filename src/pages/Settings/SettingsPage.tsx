...
import { NotifyCard } from "@/pages/Settings/components/notify-card"
import { LanguageSecurity } from "@/pages/Settings/components/language-security"
...
import { postSaveSettings } from "@/api/userApi"
export function SettingsPage() {
  ...
  const handleSaveChanges = async () => {
    ...
    dispatch({ type: USER_UPDATE_REQUESTED, payload: draftUser })
